...
def load_models():
    model = joblib.load('test-/assets/optimized_disease_predictor.pkl')
    label_encoder = joblib.load('test-/assets/label_encoder.pkl')
    selected_features = joblib.load('test-/assets/selected_features.pkl')
